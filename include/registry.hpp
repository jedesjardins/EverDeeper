						...
						sf::Font &font)
{
	...
	/*
	lua.new_usertype<std::uniform>("Random",
			"seed", [](std::default_random_engine &engine, int seed)
				{
					std::cout << "seed" << std::endl;
				},
			"random", sol::overload(
					[](std::default_random_engine &engine, int min, int max) -> int
					{
						return 0;
					},
					[](std::default_random_engine &engine, int max) -> int
					{
						return 0;
					},
					[](std::default_random_engine &engine) -> double
					{
						return 0.0;
					}
				)
